...
class EventHelper {
  // Snack Bar
  EventHelper.openSnackBar({String? title, String? message, AlertType? type, SnackPosition position = SnackPosition.TOP, IconData icon = Icons.announcement, Color backgroundColor = Colors.grey, Color textColor = Colors.black}) {
    switch (type) {
